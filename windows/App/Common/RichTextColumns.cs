...
namespace ScoutChess.Common
{
    ...
    internal sealed class RichTextColumns : Panel
    {
        /// <summary>
        /// Identifies the <see cref="RichTextContent"/> dependency property.
        /// </summary>
        internal static readonly DependencyProperty RichTextContentProperty =
        ...
        /// </summary>
        internal static readonly DependencyProperty ColumnTemplateProperty =
        ...
        /// </summary>
        internal RichTextBlock RichTextContent
        {
        ...
        /// </summary>
        internal DataTemplate ColumnTemplate
        {
