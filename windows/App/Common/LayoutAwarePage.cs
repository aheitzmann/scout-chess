...
namespace ScoutChess.Common
{
    ...
    internal class LayoutAwarePage : Page
    {
        ...
        /// </summary>
        internal static readonly DependencyProperty DefaultViewModelProperty =
        ...
        internal void StartLayoutUpdates(object sender, RoutedEventArgs e)
        {
        ...
        internal void StopLayoutUpdates(object sender, RoutedEventArgs e)
        {
            var control = sender as Control;
